...
% }
    ...
    \includegraphics[width=1.0\columnwidth]{residue_pair_distances/src_abl_combined/distances}
...
\begin{figure*}[h]
    \includegraphics[width=0.5\textwidth]{loopmodel_analysis/nmissing_resis_distributions}
