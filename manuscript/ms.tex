...
While Modeller's automodel function can generate its own alignments automatically, it was more convenient from a software architecture standpoint to use a standalone function.
...
To obtain statistics for the solvation stage without generating a sizeable amount of coordinate data {\color{red}[JDC: State how big the solvated model PDBs are?]}, the {\tt solvate} subcommand was performed for two representative individual kinases (\emph{Src} and \emph{Abl1}).
