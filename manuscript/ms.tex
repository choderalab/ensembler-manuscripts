...
{\bf Ensembler} automates much of the time-consuming process of preparing protein models suitable for simulation, while allowing scalability up to entire superfamilies.  {\color{red}[JDC: Prior sentence is redundant?]}
...
The sequence identity stratifications were selected based on the sequence identity distribution (Fig.~\ref{figure:sequence-identity-distribution}), which suggests an intuitive division into three categories, with \num{307753} models in the 0-35\% sequence identity range, \num{69922} models in the 35-55\% range, and \num{4893} models in the 55-100\% range. 
...
\begin{figure}[tb]
    ...
    % TODO may want to mention KDE smoothing
...
\subfloat[Abl]{\label{figure:abl-distances}%
  ...
  \label{figure:pair-distances-ref-structures}
\end{figure*}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% FIGURE: Pairwise distances with reference structures for Src
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[tb]
  ...
  \label{figure:src-ref-structrues}
\end{figure}
