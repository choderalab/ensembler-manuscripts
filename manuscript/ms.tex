...
For example, it should now be possible to study protein dynamics across entire (super)families, exploiting the entire variety of available structural biology data and similarities in conformations that homologous proteins can adopt.
