...
{\color{blue}[TODO: Add URL of where to get the code and TK models here]}
...
{\color{blue}[DLP: Might be worth investigating an algorithm called \emph{pokefind} (or \emph{knotfind}, which I think is an earlier version) which aims to find knots in proteins, of the type which encouraged us to use Rosetta to reconstruct template loops.
...
{\color{blue}[TODO: Add list of TK UniProt identifiers and gene names, probably in SI.]}
...
{\color{blue}[TODO: Add link to documentation. What about example inputs for generating the results in this paper? Put this in the TK model data set?]}
