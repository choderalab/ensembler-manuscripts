...
\begin{figure}[tb]
  \centering
    ...
    % \begin{subfigure}[b]{0.45\textwidth}
    %   \includegraphics[width=1.0\textwidth, clip=true, trim=30em 0em 40em 0em]{residue_pair_distances/src/inactive}
    %   \caption{Inactive}
    % \end{subfigure}
    % \begin{subfigure}[b]{0.45\textwidth}
    %   \includegraphics[width=1.0\textwidth, clip=true, trim=30em 0em 27em 10em]{residue_pair_distances/src/active}
    %   \caption{Active}
    % \end{subfigure}
