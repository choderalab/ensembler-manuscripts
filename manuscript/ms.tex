...
{\color{red}[JDC: Shouldn't we state which options we used and what Uniprot searches we used for templates and targets?  How would someone reproduce what we did here?  Can we communicate this beyond just saying ``here are the scripts''?]}
