...
% TODO Do we need to mention comparative modeling here? If not, this could be changed to:
...
Complicating matters further, in families of proteins known to be conformationally labile or able to adopt a diversity of structures---such as kinases---existing structural data may only exist for one or two conformations for any individual member of the superfamily for which there is structural data, leading to difficulties in trying to construct consistent kinetic models for comparison among different members of the same superfamily.
